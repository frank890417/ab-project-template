/** [p5.sound]  Version: 1.0.1 - 2021-05-25 */ ! function (n) {
    ...
    void 0 === (i = function () {
        ...
        return l.prototype.set = function (t, e, n) {
            ...
            if (1 === t.length && this.isObject(t[0])) i = t[0];
                ...
                for (var r = 0; r < e.length; r++) i[e[r]] = t[r];
    ...
    var i, r;
    i = [n(0), n(2), n(10)], void 0 === (r = function (e) {
        "use strict";
    ...
    var i, r;
    i = [n(0), n(6), n(9), n(18), n(10)], void 0 === (r = function (e) {
        "use strict";
    ...
    var i, r;
    i = [n(0), n(15)], void 0 === (r = function (t) {
        "use strict";
    ...
    var i, r;
    i = [n(0), n(4), n(1), n(2)], void 0 === (r = function (n) {
        "use strict";
    ...
    var i, r;
    i = [n(0), n(16), n(30), n(31), n(12)], void 0 === (r = function (e) {
        return e.Type = {
            Default: "number",
            Time: "time",
            Frequency: "frequency",
    ...
    var i, r;
    i = [n(0), n(18), n(9)], void 0 === (r = function (n) {
        "use strict";
    ...
    var i, r;
    i = [n(0), n(7), n(39), n(14), n(12)], void 0 === (r = function (r) {
        "use strict";
        return r.Clock = function () {
            r.Emitter.call(this);
            var t = this.optionsObject(arguments, ["callback", "frequency"], r.Clock.defaults);
    ...
    var i, r;
    i = [n(0), n(14)], void 0 === (r = function (i) {
        function t(t, e, n) {
    ...
    var i, r;
    i = [n(0), n(4), n(20), n(2), n(10)], void 0 === (r = function (e) {
        "use strict";
            ...
            for (var n = t.split(/\W+/), i = 0; i < n.length; i++)
                if (t = n[i], this._events.hasOwnProperty(t))
                    if (s.prototype.isUndef(e)) this._events[t] = [];
                        ...
                        for (var r = this._events[t], o = 0; o < r.length; o++) r[o] === e && r.splice(o, 1);
            return this
        }, s.Emitter.prototype.emit = function (t) {
            if (this._events) {
                var e = Array.apply(null, arguments).slice(1);
                if (this._events.hasOwnProperty(t))
                    for (var n = this._events[t], i = 0, r = n.length; i < r; i++) n[i].apply(this, e)
            }
            return this
    ...
    var i, r;
    i = [n(0), n(17)], void 0 === (r = function (n) {
        ...
        return e.Timeline = function () {
            ...
            if (this._iterating = !1, 0 < this._toRemove.length) {
                for (var r = 0; r < this._toRemove.length; r++) {
                    var o = this._timeline.indexOf(this._toRemove[r]); - 1 !== o && this._timeline.splice(o, 1)
                }
                this._toRemove = []
            }
    ...
    var i, r;
    i = [n(0), n(2), n(1), n(6)], void 0 === (r = function (t) {
        "use strict";
    ...
    var i, r;
    i = [n(0), n(2), n(32), n(38), n(10)], void 0 === (r = function (e) {
        "use strict";
    ...
    a = [], "function" != typeof AudioWorkletNode && (self.AudioWorkletNode = function (t, e, n) {
        var i = h(t)[e],
            r = t.createScriptProcessor(void 0, 2, n && n.outputChannelCount ? n.outputChannelCount[0] : 2);
    ...
    var i, r;
    i = [n(0), n(17)], void 0 === (r = function (r) {
    ...
    var i, r;
    i = [n(0), n(16)], void 0 === (r = function (i) {
    ...
    var i, r;
    i = [n(0), n(21), n(13), n(2)], void 0 === (r = function (e) {
        "use strict";
    ...
    var i, r;
    i = [n(0), n(6), n(15)], void 0 === (r = function (t) {
        "use strict";
    ...
    var i, r;
    i = [n(0), n(6), n(1), n(13)], void 0 === (r = function (e) {
        "use strict";
    ...
    var i, r;
    i = [n(0), n(6), n(2)], void 0 === (r = function (t) {
        "use strict";
    ...
    var i, r;
    i = [n(0), n(19), n(9)], void 0 === (r = function (e) {
        "use strict";
    ...
    function a(t) {
        var e, n = u(e = t.getChannelData(0), 1 < t.numberOfChannels ? t.getChannelData(1) : e),
    ...
    function y(t) {
        var e = t,
            n = new AudioWorkletNode(p.audiocontext, s.a.soundFileProcessor);
        ...
        return function (t, e, n) {
                    ...
                    s.addEventListener("progress", function (t) {
                        ...
                        if (200 === s.status) {
                            ...
                            R.decodeAudioData(s.response, function (t) {
                                ...
                                if (r.panner) {
                                    var t = new m("decodeAudioData", o, r.url),
                            ...
                            var t = new m("loadSound", o, r.url),
                                e = "Unable to load " + r.url + ". The request status was: " + s.status + " (" + s.statusText + ")";
                            i && (t.message = e, i(t))
                        }
                    }, s.onerror = function () {
                        var t = new m("loadSound", o, r.url),
            ...
            value: function (t) {
                ...
                if (t = t || 5 * window.width, this.buffer) {
                    for (var e = this.buffer, n = e.length / t, i = ~~(n / 10) || 1, r = e.numberOfChannels, o = new Float32Array(Math.round(t)), s = 0; s < r; s++)
    ...
    var j = function () {
            ...
            return function (t, e, n) {
                ...
                key: "logAverages",
                value: function (t) {
                    for (var e = p.audiocontext.sampleRate / 2, n = this.freqDomain, i = n.length, r = new Array(t.length), o = 0, s = 0; s < i; s++) {
                        Math.round(s * e / this.freqDomain.length) > t[o].hi && o++, r[o] = void 0 !== r[o] ? (r[o] + n[s]) / 2 : n[s]
                    }
                    return r
                }
            }, {
    ...
    p5.Envelope = function (t, e, n, i, r, o) {
        this.aTime = t || .1, this.aLevel = e || 1, this.dTime = n || .5, this.dLevel = i || 0, this.rTime = r || 0, this.rLevel = o || 0, this._rampHighPercentage = .98, this._rampLowPercentage = .02, this.output = p.audiocontext.createGain(), this.control = new rt.a, this._init(), this.control.connect(this.output), this.connection = null, this.mathOps = [this.control], this.isExponential = !1, this.sourceToClear = null, this.wasTriggered = !1, p.soundArray.push(this)
    ...
    var ht = function () {
        ...
        pt = function () {
            var t, e, n, i, r, o, s, a = 2 * p.audiocontext.sampleRate,
                u = p.audiocontext.createBuffer(1, a, p.audiocontext.sampleRate),
                c = u.getChannelData(0);
            t = e = n = i = r = o = s = 0;
            for (var l = 0; l < a; l++) {
                var h = 2 * Math.random() - 1;
                t = .99886 * t + .0555179 * h, e = .99332 * e + .0750759 * h, n = .969 * n + .153852 * h, i = .8665 * i + .3104856 * h, r = .55 * r + .5329522 * h, o = -.7616 * o - .016898 * h, c[l] = t + e + n + i + r + o + s + .5362 * h, c[l] *= .11, s = .115926 * h
            }
    ...
    var ie = function () {
        ...
        return function (t, e, n) {
            ...
            value: function (t, e, n, i, r, o, s) {
                return 3 === arguments.length || 4 === arguments.length ? (s = i, this.orientForward(t, e, n, s)) : 6 !== arguments.length && 7 !== arguments || (this.orientForward(t, e, n), this.orientUp(i, r, o, s)), [this.listener.forwardX.value, this.listener.forwardY.value, this.listener.forwardZ.value, this.listener.upX.value, this.listener.upY.value, this.listener.upZ.value]
            }
        }, {
            key: "orientForward",
            value: function (t, e, n, i) {
                ...
                value: function (t, i, n) {
                    ...
                    u.open("GET", r, !0), u.responseType = "arraybuffer", u.onload = function () {
                        if (200 === u.status) a.decodeAudioData(u.response, function (t) {
                            ...
                            var t = new m("decodeAudioData", s, o.url),
                                e = "AudioContext error at decodeAudioData for " + o.url;
                            n && (t.msg = e, n(t))
                        });
                        else {
                            var t = new m("loadConvolver", s, o.url),
                                e = "Unable to load " + o.url + ". The request status was: " + u.status + " (" + u.statusText + ")";
                            n && (t.message = e, n(t))
                        }
                    }, u.onerror = function () {
                        var t = new m("loadConvolver", s, o.url),
    ...
    var Sn = function () {
        ...
        return function (t, e, n) {
            ...
            key: "noteAttack",
            value: function (t, e, n) {
                var i, r = 2 < arguments.length && void 0 !== n ? n : 0,
        ...
        if ("string" == typeof t) {
            ...
            if (-1 < ["mp3", "wav", "ogg", "m4a", "aac"].indexOf(n)) {
                if (!p5.prototype.isFileSupported(n))
                    for (var i = e.split("."), r = i[i.length - 1], o = 0; o < p.extensions.length; o++) {
